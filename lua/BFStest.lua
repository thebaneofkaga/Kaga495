...
while not overlap(startDiscovered, endDiscovered) do
    ...
    for i=1, tempCounter do 
        ...
        print()
        --]]
        print("searching form: " .. startSear0ch[1][1] .. ", " .. startSearch[1][2].. "\n");
        ...
        --]]
        if tempStartNY[1] > 0 
        and tempStartNY[2] <= #grid[tempStartNY[1]] then
            --[[print("current list")
            tprint(startSearch)
            print()
            --]]
            print("checking y of " .. tempStartNY[1] .. "and x of " .. tempStartNY[2])
            if  grid[tempStartNY[1]][tempStartNY[2]] ~= "x" 
            and not discovered(startDiscovered, tempStartNY)then
